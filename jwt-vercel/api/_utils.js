...
// Vercel serverless = stateless, data disimpan sementara di global scope
// Untuk produksi: ganti dengan database (MongoDB, PlanetScale, dsb)
...
module.exports = { USERS, generateJWT, verifyJWT, getTokenFromHeader, setCors };
